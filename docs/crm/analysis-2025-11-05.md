...
4. **Contact merge flow** – დუპლების გაერთიანების პროცესი ჯერ არ არის გაწერილი (UI/logic). ნაწილობრივ ეს რისკი მინიმუმამდე დაიყვანება normalization-ით, მაგრამ მაინც საჭიროა პროცესის განსაზღვრობა.
