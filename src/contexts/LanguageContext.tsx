...
const translations: Translations = {
  ...
  dangerZone: { ka: 'საშიში ზონა', en: 'Danger zone', ru: 'Опасная зона' },
  deleteAccount: { ka: 'ანგარიშის წაშლა', en: 'Delete account', ru: 'Удалить аккаунт' },
  describe: { ka: 'აღწერა', en: 'Describe', ru: 'Описание' },
  download: { ka: 'ჩამოტვირთვა', en: 'Download', ru: 'Скачать' },
  emailNotifications: { ka: 'ელფოსტის შეტყობინებები', en: 'Email notifications', ru: 'Email-уведомления' },
  floorplans: { ka: 'გეგმარებები', en: 'Floorplans', ru: 'Планировки' },
  furniture: { ka: 'ავეჯი', en: 'Furniture', ru: 'Мебель' },
  garden: { ka: 'ბაღი', en: 'Garden', ru: 'Сад' },
  gym: { ka: 'სპორტდარბაზი', en: 'Gym', ru: 'Спортзал' },
  irreversibleActions: { ka: 'შეუქცევადი მოქმედებები', en: 'Irreversible actions', ru: 'Необратимые действия' },
  keyFacts: { ka: 'მთავარი ფაქტები', en: 'Key facts', ru: 'Ключевые факты' },
  krtsanisi: { ka: 'კრწანისი', en: 'Krtsanisi', ru: 'Крцаниси' },
  land: { ka: 'მიწა', en: 'Land', ru: 'Земля' },
  last12Months: { ka: 'ბოლო 12 თვე', en: 'Last 12 months', ru: 'Последние 12 месяцев' },
  location: { ka: 'ლოკაცია', en: 'Location', ru: 'Локация' },
  manageNotifications: { ka: 'შეტყობინებების მართვა', en: 'Manage notifications', ru: 'Управление уведомлениями' },
  nadzaladevi: { ka: 'ნაძალადევი', en: 'Nadzaladevi', ru: 'Надзаладеви' },
  parking: { ka: 'პარკინგი', en: 'Parking', ru: 'Парковка' },
  pool: { ka: 'აუზი', en: 'Pool', ru: 'Бассейн' },
  balcony: { ka: 'აივანი', en: 'Balcony', ru: 'Балкон' },
  terrace: { ka: 'ტერასა', en: 'Terrace', ru: 'Терраса' },
  elevator: { ka: 'ლიფტი', en: 'Elevator', ru: 'Лифт' },
  petsAllowed: { ka: 'შინაური ცხოველები დაშვებულია', en: 'Pets Allowed', ru: 'Разрешены животные' },
  furnished: { ka: 'ავეჯით', en: 'Furnished', ru: 'С мебелью' },
  priceHistory: { ka: 'ფასის ისტორია', en: 'Price history', ru: 'История цены' },
  pushNotifications: { ka: 'Push შეტყობინებები', en: 'Push notifications', ru: 'Push-уведомления' },
  receiveEmailUpdates: { ka: 'ელფოსტის განახლებების მიღება', en: 'Receive email updates', ru: 'Получать обновления по email' },
  receivePushUpdates: { ka: 'Push განახლებების მიღება', en: 'Receive push updates', ru: 'Получать push-обновления' },
  rent: { ka: 'ქირა', en: 'Rent', ru: 'Аренда' },
  rooms: { ka: 'ოთახები', en: 'Rooms', ru: 'Комнаты' },
  sale: { ka: 'გაყიდვა', en: 'Sale', ru: 'Продажа' },
  scheduleTour: { ka: 'ტურის დანიშვნა', en: 'Schedule a tour', ru: 'Запланировать просмотр' },
  selectPreferredTime: { ka: 'აირჩიეთ სასურველი დრო', en: 'Select preferred time', ru: 'Выберите удобное время' },
  ...
  selectType: { ka: 'აირჩიეთ ტიპი', en: 'Select a type', ru: 'Выберите тип' },
  enterValidPrice: { ka: 'შეიყვანეთ სწორი ფასი', en: 'Enter a valid price', ru: 'Введите корректную цену' },
  enterArea: { ka: 'შეიყვანეთ ფართობი', en: 'Enter area', ru: 'Введите площадь' },
  descriptionTooShort: { ka: 'აღწერა ძალიან მოკლეა', en: 'Description too short', ru: 'Описание слишком короткое' },
  enterContactName: { ka: 'შეიყვანეთ კონტაქტის სახელი', en: 'Enter contact name', ru: 'Введите имя контакта' },
  enterValidPhone: { ka: 'შეიყვანეთ სწორი ტელეფონი', en: 'Enter valid phone', ru: 'Введите корректный телефон' },
  invalid: { ka: 'არასწორი', en: 'Invalid', ru: 'Некорректно' },
  currency: { ka: 'ვალუტა', en: 'Currency', ru: 'Валюта' },
  contactName: { ka: 'კონტაქტის სახელი', en: 'Contact Name', ru: 'Имя контакта' },
  contactPhone: { ka: 'კონტაქტის ტელეფონი', en: 'Contact Phone', ru: 'Телефон контакта' },
  latitude: { ka: 'განედი', en: 'Latitude', ru: 'Широта' },
  longitude: { ka: 'გრძედი', en: 'Longitude', ru: 'Долгота' },
  cancel: { ka: 'გაუქმება', en: 'Cancel', ru: 'Отмена' },
  submit: { ka: 'გაგზავნა', en: 'Submit', ru: 'Отправить' },
  photosOptional: { ka: 'ფოტოები (სურვილისამებრ)', en: 'Photos (optional)', ru: 'Фото (опционально)' },
  dragDropImages: { ka: 'ჩააგდეთ ფოტოები აქ ან', en: 'Drag & drop images here or', ru: 'Перетащите фото сюда или' },
  browse: { ka: 'აირჩიეთ', en: 'browse', ru: 'выберите' },
  titlePlaceholder: { ka: 'თანამედროვე 2-ოთახიანი ვაკეში', en: 'Modern 2BR in Vake', ru: 'Современная 2-комн в Ваке' },
  locationPlaceholder: { ka: 'ვაკე, თბილისი', en: 'Vake, Tbilisi', ru: 'Ваке, Тბილიси' },
  pricePlaceholder: { ka: '300000', en: '300000', ru: '300000' },
  descriptionPlaceholder: { ka: 'აღწერეთ უძრავი ქონება...', en: 'Describe the property...', ru: 'Опишите недвижимость...' },
  phonePlaceholder: { ka: '+995 5XX XX XX XX', en: '+995 5XX XX XX XX', ru: '+995 5XX XX XX XX' },
  photoConstraints: { ka: 'მაქსიმუმ {maxFiles} ფოტო, JPG/PNG/WebP/AVIF, {maxSize}MB თითო', en: 'Up to {maxFiles} images, JPG/PNG/WebP/AVIF, {maxSize}MB each', ru: 'До {maxFiles} фото, JPG/PNG/WebP/AVIF, по {maxSize}МБ' },
  optional: { ka: '(სურვილისამებრ)', en: '(optional)', ru: '(опционально)' },
  ...
  sending: { ka: 'იგზავნება...', en: 'Sending...', ru: 'Отправка...' },
  sendMessage: { ka: 'შეტყობინების გაგზავნა', en: 'Send Message', ru: 'Отправить сообщение' },
  findUs: { ka: 'სად გვიპოვო', en: 'Find Us', ru: 'Как нас найти' },
  officeHours: { ka: 'სამუშაო საათები', en: 'Office Hours', ru: 'Часы работы' },
  mondayFriday: { ka: 'ორშაბათი - პარასკევი', en: 'Monday - Friday', ru: 'Понедельник - Пятница' },
  officeHoursWeekdays: { ka: '09:00 - 18:00', en: '9:00 AM - 6:00 PM', ru: '09:00 - 18:00' },
  officeHoursSaturday: { ka: '10:00 - 16:00', en: '10:00 AM - 4:00 PM', ru: '10:00 - 16:00' },
  saturday: { ka: 'შაბათი', en: 'Saturday', ru: 'Суббота' },
  sunday: { ka: 'კვირა', en: 'Sunday', ru: 'Воскресенье' },
  closed: { ka: 'დახურულია', en: 'Closed', ru: 'Закрыто' },
  ourOffices: { ka: 'ჩვენი ოფისები', en: 'Our Offices', ru: 'Наши офисы' },
  ourOfficesSubtitle: { ka: 'ეწვიე ჩვენს მოსახერხებელ ლოკაციებს საქართველოს მასშტაბით', en: 'Visit us at any of our convenient locations across Georgia', ru: 'Посетите наши удобные офисы по всей Грузии' },
